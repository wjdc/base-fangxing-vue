<template>
  <!-- 授权用户 -->
  <el-dialog title="选择用户" :visible.sync="visible" append-to-body>
    <el-form :model="queryParams" ref="queryForm" size="small" inline class="dialog-query-form">
    ...
    <el-table @row-click="clickRow" ref="table" :data="userList" @selection-change="handleSelectionChange" height="400px">
      ...
      <el-table-column label="邮箱" prop="email" :show-overflow-tooltip="true" min-width="120" />
      <el-table-column label="手机" prop="phonenumber" :show-overflow-tooltip="true" min-width="120" />
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button size="small" type="primary" @click="handleSelectUser">确定</el-button>
    </div>
  </el-dialog>
</template>
